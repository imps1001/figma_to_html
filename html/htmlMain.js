...
export const htmlMain = (sceneNode, parentIdSrc = "", isJsx = false, layerName = false) => {
...
export const htmlBuilder = (node, isJsx, isUI = false) => {
...
export const htmlContainer = (node, children, additionalStyle = "", isJsx, isInput = false, isRelative = false) => {
    var _a;
...
export const rowColumnProps = (node, isJsx) => {
    // ROW or COLUMN
...
const addSpacingIfNeeded = (node, index, len, isJsx) => {
    var _a;
